  ...
  return (
    <section className="py-24 bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-6">
        ...
        >
          <div className="bg-primary/5 border-l-4 border-primary p-6 rounded-r-xl mb-6 text-left max-w-fit mx-auto relative shadow-sm">
            <h2 className="text-2xl md:text-4xl font-extrabold text-foreground leading-tight break-keep flex items-center gap-3">
          ...
          <div className="text-lg md:text-xl text-muted-foreground font-medium leading-relaxed break-keep flex flex-col gap-5 mt-6 max-w-3xl mx-auto text-left">
            ...
            <strong className="text-primary mt-6 block text-center text-2xl font-black">KELLO는 이 문제를 완벽하게 해결합니다.</strong>
          </div>
        </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {problems.map((p, i) => (
            ...
            >
              ...
              <h3 className={`text-xl font-black ${p.color} mb-3 block`}>
                {p.title}
              </h3>
              <p className="text-muted-foreground font-medium text-base leading-relaxed break-keep">
                {p.desc}
              </p>
            </motion.div>
          ))}
